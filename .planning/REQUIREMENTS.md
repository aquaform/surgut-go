...
- [ ] **SRC-07**: Парсинг уважает robots.txt и crawl-delay; вежливые таймауты/ретраи/User-Agent
...
- [ ] **API-05**: Ответы API валидируются схемами; ошибки отдаются в предсказуемом формате
